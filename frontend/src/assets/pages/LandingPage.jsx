...
export const LandingPage = () => {
    ...
    return <>
        <div ref={nav} className="h-[13%] w-full flex justify-center align-bottom z-[999] fixed">
            <Navbar />
        </div>
        {/* mainpage */}
        <div ref={page} className="flex flex-col h-[100%] w-full">
            {/* innerpage1 */}
            <div className="flex flex-col relative items-center pt-[2%] h-[100vh] w-full bg-[url('/images/page3.avif')] bg-cover">
                <div ref={container} className="w-[70%] flex flex-col items-center mt-[6%] absolute align-top h-[80%] bg-black/20 backdrop-blur-md  border border-white/20 rounded-2xl p-6">
            ...
            <div ref={page2} className="h-[100vh] w-full relative">
                ...
                <div className="h-[100vh] z-50 absolute flex justify-between w-full">
                    {/* leftdiv */}
                    <div ref={page2ContL} className="w-[50%] pt-[5%] h-full flex justify-center items-center">
                        <img src="/images/chase.png" alt="" className="w-[70%]" />
                    </div>
                    {/* rightdiv */}
                    <div ref={page2ContR} className="w-[50%] pt-[5%] px-[40px] h-full gap-[20px] flex flex-col justify-center items-center">
                        <p className="text-white drop-shadow-[0_0_4px_rgba(255,255,255,0.6)] font-thin text-[20px] text-center">
                        ...
                        <h4 className="text-white drop-shadow-[0_0_4px_rgba(255,255,255,0.6)] text-[20px] text-center">Start now, stay sharp, and get it DONE – the justtodo.com way.</h4>
                    </div>
                </div>
            </div>
            {/* innerpage3 */}
            <div ref={page3} className="h-[100vh] w-full relative">
                ...
                <div className="h-[100vh] z-50 absolute flex justify-between w-full">
                    {/* leftdiv */}
                    <div ref={page3ContL} className="w-[50%] pt-[5%] px-[40px] h-full gap-[20px] flex flex-col justify-center items-center">
                        <div className="flex flex-col gap-5 w-full h-full items-center justify-center">
                            <p className="text-white drop-shadow-[0_0_4px_rgba(255,255,255,0.6)] font-thin text-[20px] text-left">Jutso AI knows exactly what you’re going through...
                            ...
                            <p className="text-white drop-shadow-[0_0_4px_rgba(255,255,255,0.6)] font-thin text-[20px] text-left">
                    ...
                    {/* rightdiv */}
                    <div ref={page3ContR} className="w-[50%] pt-[5%] h-full flex justify-center items-center">
                        <img src="/images/jutso.png" alt="" className="w-[70%]" />
                    </div>
                </div>
            </div>
            {/* footer */}
            {/* <footer className="h-[20vh] w-full bg-black">
