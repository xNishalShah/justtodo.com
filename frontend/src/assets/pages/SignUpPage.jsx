...
export const SignUpPage = () => {
    ...
    return <>
        <div className="h-[100vh] w-full flex flex-col">
            ...
            <div className="h-[90%] w-full flex pt-[20px] justify-center items-center bg-[url('/images/main.png')] bg-cover">
                <div className="w-[50%] h-[90%] flex flex-col px-[40px] pt-[5%] pb-[3%]  justify-between items-center bg-black/80 backdrop-blur-md  border border-white/20 rounded-2xl p-6 shadow-xl">
                    <div className="w-full h-auto flex flex-col justify-center items-start">
                        ...
                        <input type="text" name="username" id="username" className="text-white drop-shadow-[0_0_4px_rgba(255,255,255,0.6)] font-sans text-sm font-thin border-white border-b-1 w-[70%] focus:outline-none h-[30px]" />
                    </div>
                    <div className="w-full h-auto flex flex-col justify-center items-start">
                        <h3 className="text-white drop-shadow-[0_0_4px_rgba(255,255,255,0.6)] cursor-default font-sans text-xl font-thin">Email</h3>
                        <input type="email" name="email" id="email" className="text-white drop-shadow-[0_0_4px_rgba(255,255,255,0.6)] font-sans text-sm font-thin border-white border-b-1 w-[70%] focus:outline-none h-[30px]" />
                    </div>
                    <div className="w-full h-auto flex flex-col justify-center items-start">
